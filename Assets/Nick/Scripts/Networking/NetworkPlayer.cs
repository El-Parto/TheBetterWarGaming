...
namespace Networking
{
    public class NetworkPlayer : NetworkBehaviour
    {
        ...
        [SerializeField] SyncList<float> syncedFloats = new SyncList<float>();
        ...
        void OnSetColor(Color old, Color _new) 
        {
        ...
        void Update()
        {
            ...
            if (isLocalPlayer)
            {
                if (Input.GetKeyDown(KeyCode.Space)) CmdRandomColor();
                if (Input.GetKeyDown(KeyCode.E)) CmdSpawnEnemy();
            }
        }
        ...
        // 2. Must follow the correct naming convention: The function name MUST start with 'Cmd'
        ...
        // 1. Cannot return anything
        // 2. Must follow the correct naming convention: The function name MUST start with 'Rpc'
        ...
        // this is run via the network startign and the player connecting...
        // NOT Unity
